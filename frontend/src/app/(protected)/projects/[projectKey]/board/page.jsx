...
export default function BoardPage({ params }) {
  ...
  if (!project) return <div className="p-4 text-slate-500 dark:text-slate-400">Loading board...</div>;
  ...
  return (
    <div className="flex flex-col h-full bg-white text-slate-800 dark:bg-slate-950 dark:text-slate-100">
      <div className="px-4 pt-4 pb-4 border-b border-slate-200 dark:border-slate-800">
        ...
        <h1 className="text-2xl font-semibold text-slate-800 mb-4 dark:text-slate-100">{projectKey} board</h1>
